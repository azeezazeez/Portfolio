...
export const ResumeModal: React.FC<ResumeModalProps> = ({
   ...
   * ============================================================
   *
   * When the resume modal is open:
   * - The main portfolio page cannot scroll.
   * - Only the resume content area can scroll.
   * - The page does not jump to the top when the modal closes.
  ...
  useEffect(() => {
     ...
     * This prevents the page layout from shifting horizontally.
     */
    ...
    /*
     * Restore the original document state when the modal closes.
     */
    return () => {
      ...
      >
        ...
        <motion.div
          ...
          className="
            ...
            border-[#E2E8F0]
            dark:border-[#243048]
            shadow-[0_20px_60px_rgba(23,32,51,0.12)]
        ...
        >
          ...
          {/* =========================================================
              ...
              The background page remains locked.
          ========================================================== */}
          <div
            className="
              p-6
