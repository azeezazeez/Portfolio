...
const projects = [
  ...
  id: "Nexus AI",
  description: `Developed an AI-powered chatbot application using Java, Spring Boot and Redis. Integrated Groq AI for natural language processing and intelligent responses. Designed RESTful APIs for seamless communication between backend and AI models, ensuring efficient request handling and scalability.`,
  tech: ["JAVA", "SPRING BOOT", "Groq AI", "Redis"],
  image: "https://lh3.googleusercontent.com/d/18Z341Q6-Dq9OZHVhNG7kZZwMHKTLfmJM",
  github: "https://github.com/azeezazeez/Nexus-AI-Chatbot",
  demo: "https://nexus-smart-ai.vercel.app"
},
