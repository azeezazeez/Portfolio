...
export default function Contact() {
  ...
  const handleSubmit = (e: FormEvent) => {
    ...
    const gmailUrl = `https://mail.google.com/mail/?view=cm&fs=1&to=itsazeezwork@gmail.com&su=${subject}&body=${body}`;
          ...
          <div className="lg:col-span-5 space-y-6">
            <div className="luminous-card h-full">
              ...
              <div className="space-y-6">
                <a href="mailto:itsazeezwork@gmail.com" className="flex items-center gap-4 group interactive">
                  ...
                  <div>
                    ...
                    <div className="text-sm font-bold group-hover:text-[#D14836] transition-colors">itsazeezwork@gmail.com</div>
                  </div>
                </a>
