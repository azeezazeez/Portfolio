...
export const ProjectModal: React.FC<ProjectModalProps> = ({
   ...
   *
   * IMPORTANT:
   * We only use overflow:hidden.
   *
   * We DO NOT use:
   * body { position: fixed }
   *
   * This prevents the page from jumping when the modal closes.
   */
  ...
  const imageUrl = getGoogleDriveImageUrl(project.imageUrl);
   ...
   * ============================================================
   *
   * Only clicking the actual empty backdrop closes the modal.
   *
   * Clicking:
   * - image
   * - text
                  ...
                  >
                    <li className="flex items-start gap-2">
                      ...
                      <span>
                        ...
                        seamless load handling under burst queries.
                      </span>
                    </li>
                    ...
                    <li className="flex items-start gap-2">
                      ...
                      <span>
                        ...
                        automated end-to-end continuous integration.
                      </span>
                    </li>
                  </ul>
                </div>
