...
export const projectList: ProjectItem[] = [
  {
    ...
    githubUrl: 'https://github.com/azeezazeez/Zyphora-Ecommerce.git',
    liveUrl: 'https://zyphora-cart.vercel.app',
    theme: 'rose',
    metrics: 'JWT Authentication • Role-Based Authorization',
    preview: {
      type: 'dashboard',
...

  {
    ...
    githubUrl: 'https://github.com/azeezazeez/Twinkle-AI',
    liveUrl: 'https://twinkleai.vercel.app',
    theme: 'blue',
    metrics: 'AI Integration • Redis Caching',
    preview: {
      type: 'ai-chat',
      badge: 'AI Assistant'
    }
